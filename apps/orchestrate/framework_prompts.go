...
func frameworkPromptBlocks(existing string, agent AgentRecord, hasPlanSet bool) string {
	...
	add := func(gated bool, key, heading, def string) {
		...
		b.WriteString(EffectivePromptText(key, def))
	}

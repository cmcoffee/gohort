...
func restGetTemplate() Template {
	return Template{
		...
		Fields: []TemplateField{
			...
			{Key: "upload_param", Label: "File parameter (optional)", Type: "text", Group: "Request", Help: "Name a parameter here to make this an UPLOAD tool, for example \"file\".",
				Detail: "The model passes a workspace filename in it and the file is streamed as multipart. Every other argument rides along as a form field, and the body template is unused."},
			{Key: "upload_form_field", Label: "Multipart field name", Type: "text", Group: "Advanced", Advanced: true, Help: "The form field the file goes in. Blank uses \"file\".",
				Detail: "Endpoints disagree: OpenAI-compatible transcription wants \"file\", ComfyUI wants \"image\"."},

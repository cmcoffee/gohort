...
type AppAgentSpec struct {
	ID           string   `json:"id"`
	OwningApp    string   `json:"owning_app"` // DISPLAY label for the App Agents grouping — the app's own optgroup in the picker (e.g. "My Apps"). Falls back to "App Agents" when empty.

  components.pipeline_panel = function(cfg) {
    ...
    // The clarifying-question ask-card renderers used to be defined HERE, into
    // the local map above — which is why they only ever rendered on a page that
    // mounted a PipelinePanel. They are registered globally now, in
    // 35_ask_cards.js, and arrive through the window.UIBlockRenderers snapshot
    // above like any other registered type.

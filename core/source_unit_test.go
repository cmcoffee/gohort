...
// runtime seam; when a file is cut into a family (agent_loop.go became
// agent_loop.go and nine agent_loop_*.go), the wiring they assert did not move
// out of the unit, only out of the file, so this is what "the source" means.
